...
function template_settings()
{
	...
	'',
		array(
			'id' => 'enable_bookmarks',
			'label' => $txt['enable_bookmarks'],
		),
		array(
			'id' => 'enable_bebo',
			'label' => $txt['enable_bebo'],
			'description' => $txt['bebo_desc'],
			'type' => 'text',
		),
		array(
			'id' => 'enable_flickr',
			'label' => $txt['enable_flickr'],
			'description' => $txt['flickr_desc'],
			'type' => 'text',
		),
		array(
			'id' => 'enable_twitter',
			'label' => $txt['enable_twitter'],
			'description' => $txt['twitter_desc'],
            'type' => 'text',
		),
		array(
			'id' => 'enable_facebook',
			'label' => $txt['enable_facebook'],
			'description' => $txt['facebook_desc'],
			'type' => 'text',
		),
		array(
			'id' => 'enable_deviant',
			'label' => $txt['enable_deviant'],
			'description' => $txt['deviant_desc'],
            'type' => 'text',
		),
    '',	
		array(
