...
function template_main()
{
	...
	foreach ($context['categories'] as $category)
	{
		...
		echo'
		  <tr class="sub_cat">
		   <td colspan="2" class="first">',$txt['board'],'</td>
		   <td class="stats_sub">',$txt['topics'],'</td>
		   <td class="stats_sub">',$txt['posts'],'</td>
		   <td class="lastpost_sub">',$txt['last_post'],'</td>
		  </tr>';
			...
			foreach ($category['boards'] as $board)
			{
				...
				// Show some basic information about the number of posts, etc.
					...
					echo '
					<td class="windowbg" align="center" colspan="2" width="14%">', $board['posts'], ' ', $txt['redirects'], '</td>';
