...
<div id="wrapper">
    <div id="t_bar">';
           ...
           echo'
             ...
             <div class="user_bar">
			   <p class="your_avatar"><a href="', $scripturl, '?action=profile">', empty($context['user']['avatar']['image']) ? '' : $context['user']['avatar']['image'], '</a></p>
	             <span>', $txt['hello_member_ndt'], ' <span>', $context['user']['name'], '</span></span> |
...
function template_body_below()
{
	global $context, $settings, $options, $scripturl, $txt, $modSettings;
		...
		<ul class="reset">
			...
			<li class="copyright"><a href="https://www.smartforums.co" target="_blank">Smart Forums</a></li>
        </ul>';
