...
function template_body_below()
{
	...
	// This includes the themes copyrights, you are not allowed to alter or change the links here!
	echo '
	<div id="footer_section"><div class="frame">
		<ul class="reset">
			<li class="copyright">', theme_copyright(), '</li>
			<li class="copyright">Cappuccino by, <a href="http://www.smartforums.co" target="_blank">Smart Forums</a></li>
